...
function SupportPage() {
  ...
  const tickets = [
    { id: "TKT-001", subject: "Campaign not showing", status: "open", created: "2 hours ago" },
    { id: "TKT-002", subject: "Payment issue", status: "resolved", created: "1 day ago" },
  ];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Get help with your account and campaigns</p>
      </div>
